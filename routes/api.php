...
Route::post('/resetpassword',[AuthController::class,'resetPassword'])->name('api.password.reset');
...
Route::middleware(['jwt'])->group(function(){
    ...
    Route::put('/updateotherusersinfo/{id}',[AuthController::class,'updateOtherUsersInfo']);
